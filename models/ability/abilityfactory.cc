...
#include "concreteAbilities/firewallability.h"
...
std::unique_ptr<Ability> AbilityFactory::createAbility(char label) const
{
    ...
    case 'H':
        return std::make_unique<Hijack>();
    case 'L':
        return std::make_unique<Lag>();
    case 'B':
        return std::make_unique<LinkBoost>();
    case 'P':
        return std::make_unique<Polarize>();
    case 'S':
        return std::make_unique<Scan>();
    case 'T':
        return std::make_unique<Tunnel>();
    default:
